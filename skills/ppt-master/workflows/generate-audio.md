...
> ⛔ **Permanently disabled in this deployment**: narration and video-ready export rely on external TTS services. Do NOT run this workflow or `notes_to_audio.py`; `svg_to_pptx.py --recorded-narration` is rejected too. Retained for reference only.
