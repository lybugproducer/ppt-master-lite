...
**Fallback when no IDE web tools** — pause and ask the user to provide 2–4 local source files (HTML / Markdown / PDF) instead.

> Note: `web_to_md.py` (external web fetching) is **permanently disabled** in this deployment; URLs cannot be fetched.
