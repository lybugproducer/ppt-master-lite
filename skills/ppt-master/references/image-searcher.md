...
> **Note — permanently disabled**: do NOT load this reference or run `image_search.py` in this deployment. `Acquire Via: web` rows are forbidden by policy and the script refuses to run. Retained for reference only.
