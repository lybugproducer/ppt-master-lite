...
> **Note — permanently disabled**: do NOT load this reference or run `image_gen.py` in this deployment. `Acquire Via: ai` rows are forbidden by policy and the script refuses to run. Retained for reference only.
