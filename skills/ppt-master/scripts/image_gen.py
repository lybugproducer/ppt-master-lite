...
PERMANENTLY DISABLED in this deployment: AI image generation is off and
...
def main() -> int:
    ...
    print(
        "image_gen.py is permanently disabled in this deployment. "
        "AI image generation is off; PPT images must be user-provided "
        "(Acquire Via: user).",
        file=sys.stderr,
    )
    return 1
