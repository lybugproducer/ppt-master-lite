...
# notes_to_audio.py and --recorded-narration are permanently disabled (external TTS / video export)
```
...
- Recorded narration is opt-in — **permanently disabled in this deployment** (external TTS / video export off):
