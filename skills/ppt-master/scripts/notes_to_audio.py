...
def main() -> int:
    ...
    print(
        "notes_to_audio.py is permanently disabled in this deployment. "
        "Narration and video export rely on external TTS services, which are "
        "off; no external service may be used.",
        file=sys.stderr,
    )
    return 1
